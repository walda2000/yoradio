...
const ScrollConfig metaConf       PROGMEM = {{ 0, 0, 2, WA_LEFT }, 140, true, 220, 5000, 2, 25 };
const ScrollConfig title1Conf     PROGMEM = {{ 0, 19, 1, WA_LEFT }, 140, true, 220, 5000, 2, 25 };
const ScrollConfig title2Conf     PROGMEM = {{ 0, 31, 1, WA_LEFT }, 140, true, 220, 5000, 2, 25 };
const ScrollConfig playlistConf   PROGMEM = {{ TFT_FRAMEWDT, 30, 1, WA_LEFT }, 140, true, MAX_WIDTH, 500, 2, 25 };
const ScrollConfig apTitleConf    PROGMEM = {{ TFT_FRAMEWDT+1, TFT_FRAMEWDT+1, 1, WA_CENTER }, 220, false, MAX_WIDTH-2, 0, 2, 25 };
...
const WidgetConfig bitrateConf    PROGMEM = { 200, 32, 1, WA_LEFT };
const BitrateConfig fullbitrateConf PROGMEM = {{226, 0, 1, WA_LEFT}, 30 };
//const WidgetConfig voltxtConf     PROGMEM = { 32, 30, 1, WA_RIGHT };
const WidgetConfig iptxtConf      PROGMEM = { 0, 64-8, 1, WA_LEFT };
const WidgetConfig rssiConf       PROGMEM = { 0, 64-11-10, 1, WA_LEFT };
const WidgetConfig numConf        PROGMEM = { 0, 25, 1, WA_CENTER };
...
//const WidgetConfig vuConf         PROGMEM = { 0, 49, 1, WA_LEFT };
const WidgetConfig clockConf      PROGMEM = { 0, 64-8, 1, WA_RIGHT };
...
const VUBandsConfig bandsConf     PROGMEM = { 3, 4, 2, 2, 8, 3 };
...
const char        bitrateFmt[]    PROGMEM = "%d kbps";
